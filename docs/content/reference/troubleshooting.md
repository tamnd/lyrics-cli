...
Most of these come down to network reality or how lyrics serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

lyrics rate-limits like any public site. lyrics already paces
...
Where a surface is gated, lyrics reads a cookie or token you supply
...
`lyrics`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what lyrics actually did
