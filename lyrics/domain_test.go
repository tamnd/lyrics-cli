...
func TestHostWiring(t *testing.T) {
	...
	if want := "lyrics://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("lyrics", "about")
	if err != nil || got.String() != "lyrics://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want lyrics://page/about", got.String(), err)
	}
}
